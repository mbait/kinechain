...
from tests.fixtures.make_fourbar import export as export_fourbar
...
@pytest.fixture(scope="session")
def fourbar_step(tmp_path_factory) -> Path:
    """Build the fourbar.step fixture in a session-scoped tmp dir."""
    out = tmp_path_factory.mktemp("fixtures") / "fourbar.step"
    return export_fourbar(out)
